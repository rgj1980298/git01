...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item magb15 layui-col-md4 layui-row layui-col-xs12">
    ...
    <div class="layui-form-item magb15 layui-col-md4  layui-col-xs12">
        <label class="layui-form-label">班级</label>
        <div class="layui-input-block">
            <select name="gradeId" id="clazz">
                <option value="${(user.gradeId)!}">请选择</option>
            </select>
        </div>
    </div>
    <br/>
